...
internal static class MongoQueryExtensions
{
	...
	internal static async Task<IReadOnlyDictionary<TKey, TValue>> ToDictionaryImpl<TResult, TKey, TValue>(this IMongoQueryable<TResult> query, Func<TResult, TKey> keySelector, Func<TResult, TValue> valueSelector, CancellationToken cancellationToken) where TKey : notnull =>
	...
	internal static async Task<IReadOnlyList<TResult>> ToListImpl<TResult>(this IMongoQueryable<TResult> query, CancellationToken cancellationToken) =>
