...
public interface IQueryRepository<T> where T : class
{
	...
	// Filtered & Ordered
	Task<IReadOnlyList<T>> ToListAsync(Expression<Func<T, bool>> filter, Order<T> order,
		CancellationToken cancellationToken = default);
	...
	// Ordered & Paged
	Task<IReadOnlyList<T>> ToListAsync(Order<T> order, int count, int page = 1,
		CancellationToken cancellationToken = default);

	// Filtered, Ordered, & Paged
	Task<IReadOnlyList<T>> ToListAsync(Expression<Func<T, bool>> filter, Order<T> order, int count, int page = 1,
		CancellationToken cancellationToken = default);
	...
	// Child: Filtered
	Task<IReadOnlyList<TChild>> ToListAsync<TChild>(Expression<Func<TChild, bool>> filter,
		CancellationToken cancellationToken = default) where TChild : T;

	// Child: Ordered
	Task<IReadOnlyList<TChild>> ToListAsync<TChild>(Order<T, TChild> order,
		CancellationToken cancellationToken = default) where TChild : T;

	// Child: Paged
	Task<IReadOnlyList<TChild>> ToListAsync<TChild>(int count, int page = 1,
		CancellationToken cancellationToken = default) where TChild : T;

	// Child: Filtered & Ordered
	Task<IReadOnlyList<TChild>> ToListAsync<TChild>(Expression<Func<TChild, bool>> filter, Order<T, TChild> order,
		CancellationToken cancellationToken = default) where TChild : T;
	...
	// Child: Ordered & Paged
	Task<IReadOnlyList<TChild>> ToListAsync<TChild>(Order<T, TChild> order, int count, int page = 1,
		CancellationToken cancellationToken = default) where TChild : T;
	...
	// Projection: as-is
	Task<IReadOnlyList<TProjection>> ToListAsync<TProjection>(Expression<Func<T, TProjection>> projection,
		CancellationToken cancellationToken = default);
	...
	// Projection: Ordered
	Task<IReadOnlyList<TProjection>> ToListAsync<TProjection>(Order<T> order,
		Expression<Func<T, TProjection>> projection, CancellationToken cancellationToken = default);

	// Projection: Paged
	Task<IReadOnlyList<TProjection>> ToListAsync<TProjection>(Expression<Func<T, TProjection>> projection, int count,
		int page = 1, CancellationToken cancellationToken = default);

	// Projection: Filtered & Ordered
	Task<IReadOnlyList<TProjection>> ToListAsync<TProjection>(Expression<Func<T, bool>> filter, Order<T> order,
		Expression<Func<T, TProjection>> projection, CancellationToken cancellationToken = default);
	...
	Task<IReadOnlyList<TProjection>> ToListAsync<TChild, TProjection>(Expression<Func<TChild, TProjection>> projection,
		CancellationToken cancellationToken = default) where TChild : T;
	...
	Task<IReadOnlyList<TProjection>> ToListAsync<TChild, TProjection>(Order<T, TChild> order,
		Expression<Func<TChild, TProjection>> projection, CancellationToken cancellationToken = default)
		where TChild : T;
